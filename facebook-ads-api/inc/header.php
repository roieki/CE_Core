...
function print_header($facebook, $me, $user)
{
...
/* login/logout without using javascript/xfmbl:
  if ($me) {
    echo ' 
      <div>
...
*/
  echo '
      <div>
        ...
        <fb:login-button autologoutlink="true" perms="ads_management">
        </fb:login-button>
      </div>
    </body>
  </html>';
  ...
  <a href="multi_create_batch.php">Multi-Create (Batch)</a><br><br>
  ';
